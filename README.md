...
**Walkthrough video:** [Globetrotter Walkthrough](https://www.loom.com/share/84406cdf74fc411ca22448cab8c2fcdb)

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

Yes, mostly. Labs on Flexbox, semantic HTML, and media queries helped a lot for my multi-page layout. I felt least prepared on fine-tuning responsive breakpoints to match my Figma exactly, so that part took extra trial and error.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would deploy it, add a map/video stretch feature, and polish typography/colors even more. I would also improve image hosting so every gallery image source is more reliable.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

What went well was the overall structure, consistent styling, and final responsive layout matching my wireframe better. What did not go as planned at first was image links and card sizing, but I fixed both. Next time I want to try adding one interactive feature like a dropdown nav or embedded map.
...
Give a shout out to somebody from your cohort that especially helped you during your project. This can be a fellow peer, instructor, TA, mentor, etc.  - Peers and instructors!